...
abstract final class AppSpacing {
  ...
  static const double threeXl = 96.0;

  // ── Layout ────────────────────────────────────────────────────────────────
  /// Max content width for the centred 1200px container.
  ...
  static const double sectionVerticalDesktop = 96.0; // threeXl
  static const double sectionVerticalMobile = 64.0;  // twoXl

  // ── Card padding ──────────────────────────────────────────────────────────
  static const double cardPaddingDesktop = 24.0; // lg
  static const double cardPaddingMobile = 20.0;

  // ── Modal padding ─────────────────────────────────────────────────────────
  static const double modalPaddingDesktop = 48.0;
  static const double modalPaddingMobile = 24.0; // lg

  // ── Side rail / top bar ───────────────────────────────────────────────────
  static const double sideRailWidth = 60.0;
